# Migration `20190803111053`

This migration has been generated by Tyler Maschino at 8/3/2019, 11:10:53 AM.
...
You can use a specific Photon built for this migration (20190803111053)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190803111053'
